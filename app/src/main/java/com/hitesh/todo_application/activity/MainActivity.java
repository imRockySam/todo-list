...
import com.hitesh.todo_application.adapters.ToDoListAdapter;
            ...
            public void onClick(View view) {
                ...
                save.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        EditText todoNotes = dialog.findViewById(R.id.input_task_notes);
                        if (todoText.getText().length() >= 2) {
                            ...
                            Spinner getTime = dialog.findViewById(R.id.spinner);
                            EditText timeInNumb = dialog.findViewById(R.id.input_task_time);
